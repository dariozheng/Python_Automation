#! python3
# 05files_RandomQuizGenerator.py - Creates quizzes with questions and answers in
...
for quizNum in range(40): 
    ...
    for questionNum in range(50):
        ...
        for i in range(4):
            quizFile.write('    %s. %s\n' % ('ABCD'[i], answerOptions[i])) #'ABCD'[i] will treat the string as an array and will evaluate to 'A''B''C''D' on each respective iteration through the loop
        quizFile.write('\n')
